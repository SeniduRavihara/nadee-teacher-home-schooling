...
import {
  BirdSVG,
  ButterflySVG,
} from "@/components/student/decorations/ButterflyBirdSVG";
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
        ...
        <p className="text-purple-600 font-bold mb-8">
          This quiz might have been deleted or has no questions.
        </p>
        <Link
          href="/student/quizzes"
          className="px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-full font-black hover:scale-110 transition-all shadow-xl"
        >
          Back to Quizzes 🏠
        </Link>
      </div>
    ...
    return (
      <div className="max-w-3xl mx-auto py-12 px-4">
        <div className="bg-gradient-to-br from-yellow-50 via-blue-50 to-cyan-50 rounded-3xl shadow-2xl border-4 border-blue-300 p-8 text-center relative overflow-hidden">
          ...
          />
          <div
            className="absolute top-8 right-24 w-12 h-16"
            style={{ animationDelay: "0.5s" }}
          >
            <BalloonSVG
              className="w-full h-full opacity-30 animate-bounce"
              color="#C084FC"
            />
          </div>
          ...
          <div className="relative z-10">
            ...
            <p className="text-purple-600 font-bold text-lg mb-8">
              You did an amazing job on {quiz.title}! ⭐
            </p>
            ...
            <div className="flex justify-center gap-6 mb-10">
              <div className="bg-white rounded-3xl p-6 shadow-xl border-4 border-purple-300 min-w-[140px]">
                ...
                <div className="text-sm text-purple-600 font-black uppercase">
                  Score 🎯
                </div>
              </div>
              <div className="bg-white rounded-3xl p-6 shadow-xl border-4 border-green-300 min-w-[140px]">
                ...
                <div className="text-sm text-green-600 font-black uppercase">
                  Accuracy ✨
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4 text-left mb-8 max-h-[500px] overflow-y-auto pr-2">
              {quiz.questions.map((q, index) => {
                ...
                return (
                  <div
                    key={q.id}
                    className={`p-5 rounded-2xl border-4 shadow-lg ${
                      isCorrect
                        ? "border-green-300 bg-gradient-to-r from-green-50 to-emerald-50"
                        : "border-red-300 bg-gradient-to-r from-red-50 to-pink-50"
                    }`}
                  >
                    <p className="font-black text-gray-900 mb-3 text-lg">
                    ...
                    <div className="flex justify-between items-center text-sm gap-4">
                      ...
                      >
                        Your answer:{" "}
                        <strong className="text-base">{userAnswer}</strong>
                      </span>
                      {!isCorrect && (
    ...
    <div className="max-w-4xl mx-auto py-8 px-4 min-h-screen pb-20">
      ...
      <div className="bg-gradient-to-r from-blue-100 via-cyan-100 to-purple-100 rounded-3xl p-6 mb-8 shadow-lg border-4 border-blue-300 relative overflow-hidden">
        ...
        <div className="flex items-center justify-between relative z-10">
          <Link
            href="/student/quizzes"
            className="p-3 hover:bg-white/60 rounded-full transition-all hover:scale-110 border-2 border-purple-300 bg-white/40"
          >
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-4 mb-10">
            {currentQuestion?.options.map((option, index) => (
              ...
              >
                <span className="font-black text-purple-500 mr-3">
